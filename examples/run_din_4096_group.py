...
if __name__ == "__main__":
    ...
    print("This training is on Stage" + str(5))

    # C.batch_size = 256 if C.flag_stage < 4 else 64

    config_update()
    print_config_oneline()
    group_path_list = ["./staged_models_group/model_stage2_Group10-{}_amazonBooks.pth".format(e) for e in range(10)]
    group_id = C.group_id
    path = group_path_list[group_id]
    # for group_id, path in enumerate(group_path_list):
    if True:

        x, y, feature_columns, behavior_feature_list, all_mid, id_to_histmid_list = get_xy_fd(flag_stage,
                                                                                              group_num=group_num)
        ...
        f2 = open('staged_models_group/id_to_group{}_{}.pkl'.format(C.group_num, C.data), 'rb')
 ...
 \
        ...
        sql_auc = 'insert into RESULT_group(run_id,run_time,fd_lambda,bd_lambda,res,avg,std,data,metrics) values(group_id,\'{}\',{},{},\'{}\',{},{},\'{}\',\'auc\')' \
            .format(C.run, run_time, C.fd_lambda, C.bd_lambda, str(auc_res), avg_auc, auc_std, C.data)
        sql_recall5 = 'insert into RESULT_group(run_id,run_time,fd_lambda,bd_lambda,res,avg,std,data,metrics) values(group_id,\'{}\',{},{},\'{}\',{},{},\'{}\',\'recall5\')' \
            .format(C.run, run_time, C.fd_lambda, C.bd_lambda, str(recall5_res), avg_recall5, recall5_std, C.data)
        sql_recall10 = 'insert into RESULT_group(run_id,run_time,fd_lambda,bd_lambda,res,avg,std,data,metrics) values(group_id,\'{}\',{},{},\'{}\',{},{},\'{}\',\'recall10\')' \
            .format(C.run, run_time, C.fd_lambda, C.bd_lambda, str(recall10_res), avg_recall10, recall10_std, C.data)
        sql_NDCG5 = 'insert into RESULT_group(run_id,run_time,fd_lambda,bd_lambda,res,avg,std,data,metrics) values(group_id,\'{}\',{},{},\'{}\',{},{},\'{}\',\'NDCG5\')' \
            .format(C.run, run_time, C.fd_lambda, C.bd_lambda, str(NDCG5_res), avg_NDCG5, NDCG5_std, C.data)
        sql_NDCG10 = 'insert into RESULT_group(run_id,run_time,fd_lambda,bd_lambda,res,avg,std,data,metrics) values(group_id,\'{}\',{},{},\'{}\',{},{},\'{}\',\'NDCG10\')' \
            .format(C.run, run_time, C.fd_lambda, C.bd_lambda, str(NDCG10_res), avg_NDCG10, NDCG10_std, C.data)
        try:
